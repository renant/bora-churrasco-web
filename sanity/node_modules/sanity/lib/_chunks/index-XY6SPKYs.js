...
import { usePaneLayout, ChildLink, BackLink, ReferenceChildLink, ParameterizedLink, PaneRouterContext, useDeskTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, DeskToolProvider } from './desk-0Uu0Zhl2.js';
...
const paneMap = {
  component: lazy(() => import('./index-zIcnC3Fm.js')),
  document: lazy(() => import('./pane-TEq-dCXX.js')),
  documentList: lazy(() => import('./pane-7ppGEuIX.js')),
  list: lazy(() => import('./index-Vf-P_8IU.js'))
};
...
//# sourceMappingURL=index-XY6SPKYs.js.map
