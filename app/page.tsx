    ...
    <main className='px-4 '>
      <section className="container mx-auto py-12 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-red-800/80">
              Calcule com precisão a quantidade ideal de carnes e bebidas para seu evento. Sem desperdícios, sem faltar
              nada.
            </p>
            <div className="flex flex-row items-center gap-4 pt-4">
              <Button className="bg-red-600 hover:bg-red-700 text-white h-12 px-6" asChild>
          ...
          <div className="relative">
            <div className="absolute -top-10 -left-10 w-64 h-64 bg-red-400 rounded-full filter blur-3xl opacity-20"></div>
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-red-400 rounded-full filter blur-3xl opacity-20"></div>
            <div className="relative bg-gradient-to-br from-red-600 to-red-700 rounded-3xl p-8 shadow-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 shadow-lg">
                  <h3 className="text-xl font-semibold text-white mb-4">Calculadora de Churrasco</h3>
                  <div className="space-y-4">
                    ...
                    <Button className="w-full bg-white text-red-700 hover:bg-red-50 mt-2" asChild>
                      <Link href="/participantes">
                        Calcular Churrasco
                      </Link>
                    </Button>
        ...
        <div className="prose prose-base mx-auto" id="content">
          <h2 className='text-red-500'>Calculadora de Churrasco: Planeje Seu Evento com a Ferramenta do Bora Churrasco</h2>
          <p>
            Descobrir a quantidade certa de comida e bebida para um churrasco pode ser um verdadeiro desafio. Com a exclusiva <strong className='text-red-600'>Calculadora de Churrasco do Bora Churrasco</strong>, nunca foi tão fácil acertar em cheio no cálculo e garantir que todos os seus convidados saiam satisfeitos. Acompanhe a seguir como nossa ferramenta inovadora em cinco passos pode revolucionar a maneira como você planeja seu churrasco:
          </p>
          ...
          <p>
            Ajustar a quantidade de comida e bebida também depende do tempo que você planeja para o seu evento. Nosso sistema considera o tempo estimado do churrasco para garantir que todos estejam bem servidos do início ao fim com a ajuda da <strong className='text-red-600'>calculadora de churrasco.</strong>
          </p>
          ...
          <p>
            Com a <strong className='text-red-600'>Calculadora de Churrasco do Bora Churrasco</strong>, o planejamento do seu evento fica mais simples e eficiente. Nossa ferramenta foi pensada para os entusiastas do churrasco que não querem se preocupar com complexos cálculos e preferem focar no que realmente importa: desfrutar de bons momentos ao lado de amigos e familiares.
          </p>

          <p>
            <strong className='text-red-600'>Bora Churrasco</strong> não é apenas o destino para quem quer acertar no churrasco; é o começo de uma experiência inesquecível que começa com o planejamento. Explore agora nossa <a href='https://www.borachurrasco.app'>Calculadora de Churrasco</a> e faça do seu próximo evento um sucesso absoluto!
          </p>

          <p>
            <strong className='text-red-600'>Importante:</strong> Diversos fatores podem impactar o consumo estimado para o seu evento, incluindo o horário da realização, condições climáticas e outros aspectos relevantes.
          </p>
        </div>
