export default function PrivacyPage() {
  return (
    <div className="container prose p-4 text-white">
      <h2>
        <span>Política Privacidade</span>
      </h2>
      <p>
        <span>
          A sua privacidade é importante para nós. É política do borachurrasco
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site{' '}
          <a href="https://www.borachurrasco.app/">borachurrasco</a>, e outros
      ...
      <p>
        <span>
          ...
          informação que o borachurrasco oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          <span>
            ...
            (softwares) do borachurrasco, de seus fornecedores ou terceiros,
