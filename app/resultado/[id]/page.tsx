    ...
    <>
      <main className="flex flex-col items-center justify-between w-full max-w-7xl mx-auto md:p-16 p-4">
        ...
        <div className="prose prose-base mt-8 w-full max-w-3xl">
          <h2 className='text-red-500'>Como Calcular a Quantidade de Carne para o Churrasco Perfeito</h2>
          ...
          <h3 className='text-red-500'>1. Entendendo o Básico: A Regra dos 400g</h3>
          ...
          <p><strong className='text-red-600'> - Degustação:</strong> Um evento rápido, que serve como aperitivo ou encerramento de outro evento. Neste caso, 200 a 300 gramas por pessoa são suficientes.</p>

          <p><strong className='text-red-600'> - Almoço ou Jantar Prolongado:</strong> Aqui, estamos falando de um evento que dura entre 4 a 5 horas. A quantidade recomendada aumenta para 400 a 500 gramas por participante.</p>

          <p><strong className='text-red-600'> - Churrasco sem Hora para Acabar:</strong> O famoso churrasco de fim de semana que começa ao meio-dia e só termina... bem, quando o último resistente se rende. Neste cenário, esteja preparado com 500 a 600 gramas por pessoa.</p>
          ...
          <p><strong className='text-red-600'>Maioria de Mulheres e Crianças:</strong> Geralmente, esse grupo consome menos carne, então você pode reduzir a conta em cerca de 100 gramas por pessoa.</p>

          <p><strong className='text-red-600'>Maioria de Homens Adultos:</strong> Principalmente se forem amigos reunidos para assistir ao jogo, adicione de 100 a 200 gramas extras por pessoa à sua estimativa inicial.</p>
          ...
          <p><strong className='text-red-600'>Almoço Completo com Acompanhamentos:</strong> Se vai ter salada, maionese, vinagrete, pão de alho, entre outros, você pode reduzir a carne em cerca de 100 gramas por pessoa.</p>

          <p><strong className='text-red-600'>Churrasco Básico:</strong> Se pretende manter tudo simples, talvez só com um vinagrete e pãozinho, considere adicionar mais 100 gramas de carne na sua conta.</p>

          <h3 className='text-red-500'>5. Dicas de Ouro Para o Sucesso do Churrasco</h3>

          <p><strong className='text-red-600'>Variedade de Cortes:</strong> Ofereça diferentes tipos de carnes. Isso agrada a vários paladares e ajuda a equilibrar o consumo.</p>

          <p><strong className='text-red-600'>Bebidas e Entradas:</strong> Aperitivos e bebidas podem influenciar na quantidade de carne consumida. O ideal é ter um equilíbrio.</p>

          <p><strong className='text-red-600'>Sobras:</strong> Melhor sobrar do que faltar. Se tiver sobras, existem várias receitas deliciosas para aproveitar a carne do churrasco no dia seguinte.</p>
          ...
          <h4 className='text-red-500'>E se eu estiver fazendo um churrasco misto com frango e carne?</h4>
          ...
          <h4 className='text-red-500'>Como calcular a quantidade de carvão?</h4>
