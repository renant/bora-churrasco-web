    ...
    <div className="min-h-screen bg-white">
      <main className="flex flex-col items-center justify-between w-full max-w-7xl mx-auto px-4 md:px-16 py-8 md:py-16">
        ...
        <div className="text-center mb-12 md:mb-16">
          <div className="inline-flex items-center gap-3 bg-gray-50 rounded-lg px-6 py-3 shadow-md border border-gray-200 mb-6">
        ...
        {/* Results Section */}
        <div className="w-full bg-gray-50 rounded-lg shadow-lg border border-gray-200 p-6 md:p-8 mb-12 md:mb-16">
