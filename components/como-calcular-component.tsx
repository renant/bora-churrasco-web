export default function ComoCalcularComponent() {
  return (
    <div className="w-full max-w-4xl bg-white rounded-lg shadow-md border border-gray-200 p-6 md:p-8 lg:p-12">
      <div className="prose prose-lg md:prose-xl max-w-none prose-headings:text-red-600 prose-headings:font-bold prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:mb-6 prose-h3:text-xl md:prose-h3:text-2xl prose-h3:text-orange-600 prose-p:text-gray-700 prose-p:leading-relaxed prose-a:text-red-500 prose-a:font-semibold prose-strong:text-red-700 prose-ul:text-gray-700 prose-ol:text-gray-700 prose-li:leading-relaxed">
        ...
        <p>
          Churrasco é sinônimo de alegria, confraternização e claro, de uma boa
          carne assada. Mas, quantas vezes você já se pegou na dúvida sobre a
          quantidade de carne a comprar para seu churrasco? Faltou carne ou
          sobrou muito, e agora? Não se preocupe! Este artigo é o seu guia
          definitivo para nunca mais errar na quantidade de carne para
        ...
        <p>
          ...
          quantidade. Na dúvida use a calculadora
        </p>
        ...
        <p>
          O tipo de evento é o primeiro fator a considerar. Nem todo churrasco é
          igual, certo?
        </p>
        ...
        <p>
          ...
          quantidade recomendada aumenta para 400 a 500 gramas por participante.
        </p>
        ...
        <p>
          ...
          Geralmente, esse grupo consome menos carne, então você pode reduzir a
          conta em cerca de 100 gramas por pessoa.
        </p>
        ...
        <p>
          <strong className="text-red-600">Variedade de Cortes:</strong> Ofereça
          diferentes tipos de carnes. Isso agrada a vários paladares e ajuda a
        ...
        <p>
          <strong className="text-red-600">Sobras:</strong> Melhor sobrar do que
          faltar. Se tiver sobras, existem várias receitas deliciosas para
        ...
        <p>
          A arte de calcular a quantidade de carne para churrasco exige um pouco
          de prática e conhecimento sobre os seus convidados. Com as dicas
          acima, você estará bem-preparado para fazer um churrasco memorável,
          sem desperdícios ou a frustrante situação de ficar sem carne.
          Lembre-se, o segredo está no planejamento e na adaptação às
        ...
        <p>
          A regra dos 400 gramas ainda se aplica, mas você pode dividir entre os
          tipos de carnes. Por exemplo, 200 gramas de carne bovina e 200 gramas
          de frango por pessoa.
        </p>

        <h4 className="text-red-500">Como calcular a quantidade de carvão?</h4>
        <p>
          Uma boa regra é usar 1,5 kg de carvão para cada kg de carne. Isso pode
          variar conforme o tipo de churrasqueira e a duração do churrasco.
        </p>
