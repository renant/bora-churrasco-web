          ...
          <AccordionContent>
            <div className="grid grid-cols-1 gap-2 text-justify font-light text-black">
              <p>
                ...
                preferimos deixar essa parte com você.
              </p>
              <p>
          ...
          <AccordionContent>
            <div className="grid grid-cols-1 gap-2 text-justify font-light text-black">
              <p>
                ...
                400g de carne, uma mulher 300g e uma criança 200g. Com base
                nisso, o aplicativo calcula a quantidade necessária de cada item
                para a compra.
              </p>
              <p>
                No caso das cervejas, o cálculo leva em conta o total de adultos
                presentes. Para cada adulto, é calculada uma média de 1L de
                cerveja. Quanto aos refrigerantes e sucos, considera-se uma
                média de 600ml por pessoa, e para a água, 200ml por pessoa.
              </p>
              <p>
              ...
              <p>
                ...
                para determinar as médias, mas, naturalmente, podem variar de
                acordo com as particularidades do seu churrasco.
              </p>
            </div>
          </AccordionContent>
        </AccordionItem>
